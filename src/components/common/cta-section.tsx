  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-[#1b3556] to-[#162840] pt-20 pb-10 md:pt-28 md:pb-12">
      <div
        ...
        style={{
          backgroundImage: `repeating-linear-gradient(90deg, rgba(255,255,255,0.02) 0 1px, transparent 1px 48px), repeating-linear-gradient(0deg, rgba(255,255,255,0.02) 0 1px, transparent 1px 48px)`,
        }}
      />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-200">
            Let's discuss how we can bring your construction vision to life. Get
