...
export default async function ProjectsPage({
  ...
  return (
    <main>
      <section className="relative overflow-hidden bg-slate-900" style={{ minHeight: '300px' }}>
        <div
        ...
        />
        <div
          className="absolute inset-0 bg-[linear-gradient(115deg,rgba(15,23,42,0.92)_0%,rgba(15,23,42,0.82)_38%,rgba(15,23,42,0.65)_65%,rgba(15,23,42,0.88)_100%)]"
          aria-hidden="true"
        />
